...
function renderDashboard(d) {
  ...
  page.innerHTML = `
    ...
    <div class="hero-grid" style="margin-bottom:12px">
      <div class="hero-card">
        <div class="card-label">${ICONS.pieChart} Patrimoine total <span data-tip="Somme : portefeuille boursier + liquidités coffres + actifs physiques + réserves libérables (montant non encore libéré)" style="cursor:help;opacity:.6;font-size:11px">ⓘ</span></div>
      ...
      <div class="hero-card">
        <div class="card-label">${ICONS.landmark} Liquidités coffres <span data-tip="Solde total de tous les coffres actifs (entrées − sorties depuis l'ouverture)" style="cursor:help;opacity:.6;font-size:11px">ⓘ</span></div>
      ...
      <div class="hero-card">
        <div class="card-label">${ICONS.gem} Actifs physiques <span data-tip="Somme des valeurs estimées des actifs physiques non vendus (immobilier, véhicules, bijoux…)" style="cursor:help;opacity:.6;font-size:11px">ⓘ</span></div>
      ...
      <div class="hero-card">
        <div class="card-label">${ICONS.wallet} Réserves libérables <span data-tip="Montant des réserves constitué mais pas encore libéré. Le total constitué (${fmtEur(res.total_amount)}) inclut aussi les sommes déjà libérées." style="cursor:help;opacity:.6;font-size:11px">ⓘ</span></div>
    ...
    <div class="hero-grid" style="margin-bottom:20px">
      <div class="hero-card">
        <div class="card-label">Valeur actuelle <span data-tip="Valeur de marché de toutes les positions (ETF, actions, liquidités SaxoBank), hors coffres et actifs physiques" style="cursor:help;opacity:.6;font-size:11px">ⓘ</span></div>
      ...
      <div class="hero-card">
        <div class="card-label">${ICONS.chartUp} Variation du jour <span data-tip="Variation de valeur du portefeuille boursier depuis la clôture d'hier" style="cursor:help;opacity:.6;font-size:11px">ⓘ</span></div>
      ...
      <div class="hero-card">
        <div class="card-label">Performance totale <span data-tip="Gain/perte total depuis l'achat sur toutes les positions actives (unrealized + realized sur ventes partielles), hors liquidités" style="cursor:help;opacity:.6;font-size:11px">ⓘ</span></div>
    ...
    <div class="grid-3" style="margin-bottom:24px">
      ...
      <div class="card card-sm">
        <div class="card-title">Top movers <span style="font-size:11px;color:var(--text-secondary);font-weight:400">portefeuille</span>
          <span data-tip="% affiché = P&amp;L total depuis l'achat (gain/perte global), pas la variation du jour" style="cursor:help;color:var(--text-secondary);font-size:12px;font-weight:400;margin-left:4px">ⓘ</span>
        </div>
